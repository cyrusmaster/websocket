...
public class Handler extends TextWebSocketHandler {
	...
	@Override
	  public void afterConnectionEstablished(WebSocketSession session) throws Exception {
	  	session.sendMessage(new TextMessage("erere"));
    }
    ...
    @Override
     protected void handleTextMessage(WebSocketSession session, TextMessage message) throws Exception {
		...
		System.out.println("geerer:" + message.getPayload());
		session.sendMessage(new TextMessage("rere:" + message.getPayload()));
    }
	...
	//
    //// 用户标识
    //private static final String USER_ID = "WEBSOCKET_USERID";   //对应拦截器中的key
	//
    //public Handler() { }
	//
	//
    ...
    //    System.out.println(userId + "=> 成功建立websocket连接!");
    ...
    //     */
    //    String userId = (String) session.getAttributes().get(USER_ID);
    //    System.out.println("服务器收到"+userId+"消息："+message);
	//
